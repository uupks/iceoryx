...
constexpr const char IOX_UDS_SOCKET_PATH_PREFIX[] = "/data/local/tmp/";
constexpr const char IOX_LOCK_FILE_PATH_PREFIX[] = "/data/local/tmp/";
constexpr const char IOX_TEMP_DIR[] = "/data/local/tmp/";
